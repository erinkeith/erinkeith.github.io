...
<strong>git</strong> is an application that gets installed onto your computer and is what's being "invoked" when you run any `git` or `gh student` CLI commands.
